...
RELEASE_NOTES = {
    "1.5.1": [
        "プレビュー更新エラーを修正（runJavaScript APIシグネチャ）",
        "印刷プレビューのインポートエラーを修正（相対→絶対インポート）",
        "エクスポート後のファイルオープンエラーを修正（sys/os/subprocess）",
        "content_changedシグナルの引数エラーを修正",
        "プロジェクト名変更時のupdate_titleエラーを修正",
        "問題タイプに「なし」オプションを追加（表示なし）",
    ],
    "1.5.0": [
